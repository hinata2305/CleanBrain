function [p, T2, df, r_jk, r_jh, r_kh]=r_test_paired_abs(j,k,h,tail, absolute)
...
%
% Usage:
%  >> [p, T2, df, r_jk, r_jh, r_kh]=r_test_paired(j,k,h,tail,absolute);
%
% Required Inputs:
...
%
%           absolute: test the difference for absolute correlation)
%
